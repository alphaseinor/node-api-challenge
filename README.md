...
Express is unopinionated, so long as middleware is compatible, it can be inserted into the request handling chain, pretty much in any order (yes it does matter what order, but I haven't really studied enough to figure out exact use cases)

- [x] Describe Middleware? 

Middleware is just a function that is chained from another function, so far we have authenticated data, but it could be used in many other ways, like authorization.

- [x] Describe a Resource? 

a resource is just a store of information.

- [x] What can the API return to help clients know if a request was successful?

a 2xx request would be a good example of a successful request based on the SIP response code index

- [x] How can we partition our application into sub-applications? 

You can partition an application into "sub applications" by making more than one router.
